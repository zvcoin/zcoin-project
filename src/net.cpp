...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Zoocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zoocointools.com", "dnsseed.zoocointools.com"},
    {"zoocoinpool.org", "dnsseed.zoocoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"zoocointools.com", "testnet-seed.zoocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zoocoin is probably already running."), addrBind.ToString().c_str());
        else
